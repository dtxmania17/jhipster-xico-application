package jp.co.xico.web.rest;

import static jp.co.xico.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import jp.co.xico.IntegrationTest;
import jp.co.xico.config.Constants;
import jp.co.xico.domain.User;
import jp.co.xico.repository.AuthorityRepository;
import jp.co.xico.repository.UserRepository;
import jp.co.xico.security.AuthoritiesConstants;
import jp.co.xico.service.UserService;
import jp.co.xico.service.dto.AdminUserDTO;
import jp.co.xico.service.dto.PasswordChangeDTO;
import jp.co.xico.service.dto.UserDTO;
import jp.co.xico.web.rest.vm.KeyAndPasswordVM;
import jp.co.xico.web.rest.vm.ManagedUserVM;
